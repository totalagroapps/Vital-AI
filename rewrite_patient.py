          ...
          <div className="flex items-start gap-3 mb-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-[11px] text-gray-500 leading-relaxed pr-2">
                Consulta sobre tu salud o descubre los <span className="text-brand-purple font-medium">ltimos avances m&#233;dicos y cient&#237;ficos</span> sobre cualquier enfermedad.
              </p>
            </div>
          </div>
...
with open(file_path, 'w', encoding='utf-8') as f:
    f.write(content.replace('', '&uacute;'))
print("PatientHome completely rewritten!")
