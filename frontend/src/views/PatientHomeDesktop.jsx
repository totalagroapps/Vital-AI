...
const PatientHomeDesktop = ({ onNavigate, onLogout, userProfile, username }) => {
  ...
  return (
    <div className="h-screen w-full bg-white text-slate-900 flex flex-col justify-between font-sans select-none overflow-hidden">
      ...
      {/* 2. HERO SECTION */}
      <section className="w-full flex-1 min-h-0 relative overflow-hidden flex items-center justify-center py-0 xl:py-1">
        {/* Soft flowing cyan/blue ethereal wave spanning behind emblem and 3 pillars */}
        <div 
          className="absolute right-0 top-0 bottom-0 w-[75%] pointer-events-none select-none"
          style={{
            background: 'radial-gradient(ellipse 65% 55% at 42% 50%, rgba(186, 235, 255, 0.68) 0%, rgba(215, 245, 255, 0.45) 40%, rgba(240, 236, 255, 0.18) 75%, transparent 100%), radial-gradient(ellipse 75% 65% at 85% 45%, rgba(223, 245, 250, 0.58) 0%, rgba(238, 236, 248, 0.32) 50%, transparent 80%)'
          }}
        />

        <div className="w-full px-6 sm:px-10 lg:px-12 xl:px-16 2xl:px-24 flex items-center justify-between gap-5 lg:gap-6 xl:gap-10 2xl:gap-14 relative z-10">
          
          {/* Columna Izquierda: Titular H1 + Tarjeta de Confianza */}
          <div className="w-[34%] max-w-[420px] lg:max-w-[460px] xl:max-w-[520px] flex flex-col justify-center shrink-0">
            <h1 className="text-2xl sm:text-3xl lg:text-4xl xl:text-[46px] 2xl:text-[54px] font-black text-slate-950 leading-[1.06] tracking-tight mb-3 lg:mb-4 xl:mb-5">
            ...
            <div 
              ...
              className="bg-[#edf5fe] hover:bg-[#e4effd] border border-[#d6e8fc] rounded-2xl p-3 sm:p-3.5 xl:p-4 flex items-center gap-3.5 max-w-[410px] xl:max-w-[460px] shadow-2xs transition-all cursor-pointer group"
            >
              <div className="w-10 h-10 lg:w-11 lg:h-11 xl:w-12 xl:h-12 rounded-2xl bg-[#dbeefe] text-[#005dff] flex items-center justify-center shrink-0 shadow-2xs">
              ...
              <div>
                ...
                <p className="text-[9.5px] sm:text-[10px] lg:text-[11px] xl:text-[12px] text-slate-600 leading-snug mt-1">
          ...
          <div className="flex-1 flex items-center justify-center relative min-w-0">
            <img 
              ...
              alt="MIVOR.ai" 
              className="w-full max-w-[320px] sm:max-w-[380px] lg:max-w-[460px] xl:max-w-[530px] 2xl:max-w-[590px] max-h-[min(56vh,560px)] h-auto object-contain relative z-10 select-none pointer-events-none drop-shadow-sm" 
            />
          </div>

          {/* Columna Derecha: Los 3 Pilares */}
          <div className="flex flex-col justify-center gap-3 lg:gap-4 xl:gap-5 2xl:gap-6 w-[27%] max-w-[340px] lg:max-w-[380px] xl:max-w-[420px] shrink-0">
            ...
            <div className="flex items-center gap-3 lg:gap-3.5 xl:gap-4 group cursor-default">
              ...
              <div>
                ...
                <p className="text-[10px] sm:text-[10.5px] lg:text-[11px] xl:text-[12px] 2xl:text-[12.5px] text-slate-600 leading-snug mt-0.5">
      ...
      <section className="w-full shrink-0 pb-3 sm:pb-3.5 lg:pb-4 xl:pb-4.5 2xl:pb-5 pt-0">
        <div className="w-full px-6 sm:px-10 lg:px-12 xl:px-16 2xl:px-24 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 lg:gap-3 xl:gap-4 2xl:gap-4.5">
          
          {/* Tarjeta 1: Pregunta a MIVOR.ai (Pastel Lavender #f4f2fd) */}
          <div 
            onClick={() => onNavigate('general_chat')}
            className="bg-[#f4f2fd] hover:bg-[#ece8fa] rounded-[22px] p-3.5 xl:p-4 flex flex-col justify-between h-[175px] lg:h-[180px] xl:h-[195px] 2xl:h-[210px] shadow-2xs hover:shadow-md hover:-translate-y-0.5 transition-all cursor-pointer group"
          >
            <div>
              <div className="w-9 h-9 xl:w-9.5 xl:h-9.5 rounded-full bg-[#ece6fb] flex items-center justify-center text-[#7012ff] mb-1.5 xl:mb-2 group-hover:scale-105 transition-transform shrink-0">
                <Brain size={20} className="stroke-[2.1]" />
              </div>
              <h3 className="font-bold text-xs sm:text-[13px] lg:text-[13.5px] xl:text-[14.5px] 2xl:text-[15.5px] text-slate-900 mb-1 leading-snug">
                {t('card_ask_title') || 'Pregunta a MIVOR.ai'}
              </h3>
              <p className="text-[9.5px] sm:text-[10px] lg:text-[10.5px] xl:text-[11.5px] 2xl:text-[12px] text-slate-600 leading-[1.38] font-normal">
            ...
            <div className="w-8 h-8 xl:w-8.5 xl:h-8.5 rounded-full bg-[#5c03f8] text-white flex items-center justify-center shadow-xs group-hover:scale-110 active:scale-95 transition-transform self-end mt-auto shrink-0">
              <ArrowRight size={15} className="stroke-[2.5]" />
            </div>
          </div>

          {/* Tarjeta 2: Analiza tus pruebas médicas (Pastel Sky Blue #eaf7fd) */}
          <div 
            onClick={() => onNavigate('documents')}
            className="bg-[#eaf7fd] hover:bg-[#ddf2fd] rounded-[22px] p-3.5 xl:p-4 flex flex-col justify-between h-[175px] lg:h-[180px] xl:h-[195px] 2xl:h-[210px] shadow-2xs hover:shadow-md hover:-translate-y-0.5 transition-all cursor-pointer group"
          >
            <div>
              <div className="w-9 h-9 xl:w-9.5 xl:h-9.5 rounded-full bg-[#dcf1fd] flex items-center justify-center text-[#005dff] mb-1.5 xl:mb-2 group-hover:scale-105 transition-transform shrink-0">
                <svg className="w-5 h-5 text-[#005dff]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.1" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
                  <polyline points="14 2 14 8 20 8" />
                  <line x1="8" y1="10" x2="11" y2="10" />
                  <line x1="8" y1="13" x2="14" y2="13" />
                  <path d="M7 18.5l3-3.5 2.2 2.5 2.3-2.5 2.5 3.5H7z" />
                </svg>
              </div>
              <h3 className="font-bold text-xs sm:text-[13px] lg:text-[13.5px] xl:text-[14.5px] 2xl:text-[15.5px] text-slate-900 mb-1 leading-snug">
            ...
            <div className="w-8 h-8 xl:w-8.5 xl:h-8.5 rounded-full bg-[#005dff] text-white flex items-center justify-center shadow-xs group-hover:scale-110 active:scale-95 transition-transform self-end mt-auto shrink-0">
              <ArrowRight size={15} className="stroke-[2.5]" />
            </div>
          </div>
          ...
          <div 
            ...
            className="bg-[#e8fdf8] hover:bg-[#d8f9f0] rounded-[22px] p-3.5 xl:p-4 flex flex-col justify-between h-[175px] lg:h-[180px] xl:h-[195px] 2xl:h-[210px] shadow-2xs hover:shadow-md hover:-translate-y-0.5 transition-all cursor-pointer group"
          >
            <div>
              <div className="w-9 h-9 xl:w-9.5 xl:h-9.5 rounded-full bg-[#d6f5ec] flex items-center justify-center text-[#01c6af] mb-1.5 xl:mb-2 group-hover:scale-105 transition-transform shrink-0">
                <Folder size={20} className="stroke-[2.1]" />
              </div>
              <h3 className="font-bold text-xs sm:text-[13px] lg:text-[13.5px] xl:text-[14.5px] 2xl:text-[15.5px] text-slate-900 mb-1 leading-snug">
            ...
            <div className="w-8 h-8 xl:w-8.5 xl:h-8.5 rounded-full bg-[#00c5a0] text-white flex items-center justify-center shadow-xs group-hover:scale-110 active:scale-95 transition-transform self-end mt-auto shrink-0">
              <ArrowRight size={15} className="stroke-[2.5]" />
            </div>
          </div>
          ...
          <div 
            onClick={() => onNavigate('search')}
            className="bg-[#fef7f1] hover:bg-[#fdeee3] rounded-[22px] p-3.5 xl:p-4 flex flex-col justify-between h-[175px] lg:h-[180px] xl:h-[195px] 2xl:h-[210px] shadow-2xs hover:shadow-md hover:-translate-y-0.5 transition-all cursor-pointer group"
          >
            <div>
              <div className="w-9 h-9 xl:w-9.5 xl:h-9.5 rounded-full bg-[#fde9dc] flex items-center justify-center text-[#fc792b] mb-1.5 xl:mb-2 group-hover:scale-105 transition-transform shrink-0">
                <Lightbulb size={20} className="stroke-[2.1]" />
              </div>
              <h3 className="font-bold text-xs sm:text-[13px] lg:text-[13.5px] xl:text-[14.5px] 2xl:text-[15.5px] text-slate-900 mb-1 leading-snug">
            ...
            <div className="w-8 h-8 xl:w-8.5 xl:h-8.5 rounded-full bg-[#fc792b] text-white flex items-center justify-center shadow-xs group-hover:scale-110 active:scale-95 transition-transform self-end mt-auto shrink-0">
              <ArrowRight size={15} className="stroke-[2.5]" />
            </div>
          </div>

          {/* Tarjeta 5: Encuentra tu médico (Pastel Lilac #f4f2fd) */}
          <div 
            onClick={() => onNavigate('doctors')}
            className="bg-[#f4f2fd] hover:bg-[#eae6fc] rounded-[22px] p-3.5 xl:p-4 flex flex-col justify-between h-[175px] lg:h-[180px] xl:h-[195px] 2xl:h-[210px] shadow-2xs hover:shadow-md hover:-translate-y-0.5 transition-all cursor-pointer group"
          >
            <div>
              <div className="w-9 h-9 xl:w-9.5 xl:h-9.5 rounded-full bg-[#ece6fb] flex items-center justify-center text-[#5803f6] mb-1.5 xl:mb-2 group-hover:scale-105 transition-transform shrink-0">
                <svg className="w-5 h-5 text-[#5803f6]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.1" strokeLinecap="round" strokeLinejoin="round">
