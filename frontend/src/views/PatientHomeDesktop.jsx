...
const PatientHomeDesktop = ({ onNavigate, onLogout, userProfile, username }) => {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 flex flex-col justify-between font-sans select-none overflow-x-hidden">
      ...
      {/* 1. TOP NAVBAR (Centered container max-w-7xl) */}
      <header className="w-full border-b border-slate-100 bg-white/95 backdrop-blur-sm sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 xl:px-10 py-3.5 flex items-center justify-between">
          {/* Brand Logo */}
          <div 
          ...
          >
            <img 
              ...
              className="h-8 lg:h-9 w-auto object-contain transition-transform" 
          ...
          <nav className="hidden md:flex items-center gap-8 lg:gap-10 xl:gap-12">
            ...
            <button 
              onClick={() => onNavigate('home')} 
              className="text-sm font-semibold text-[#005dff] transition-colors py-1 cursor-pointer relative flex flex-col items-center"
            >
              <span>{t('patient_nav_home') || 'Inicio'}</span>
              <span className="absolute -bottom-1 w-full h-[2.5px] bg-[#005dff] rounded-full" />
            </button>
            
            <button 
              onClick={() => setShowAboutModal(true)} 
              className="text-sm font-medium text-slate-800 hover:text-[#005dff] transition-colors py-1 cursor-pointer"
            >
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div 
              ...
              className="w-9 h-9 rounded-full overflow-hidden border border-slate-200 shadow-2xs cursor-pointer hover:ring-2 hover:ring-[#005dff]/40 transition-all shrink-0"
            ...
            <div className="relative">
              <button 
                type="button"
                onClick={() => setShowUserMenu(prev => !prev)}
                className="bg-[#005dff] hover:bg-[#0052e0] active:scale-95 text-white font-semibold text-xs sm:text-sm px-5 py-2.5 rounded-full shadow-xs flex items-center gap-2 transition-all cursor-pointer select-none focus:outline-none focus:ring-2 focus:ring-[#005dff]/30"
                title={userProfile?.full_name || username || "Mi cuenta"}
              >
      ...
      {/* 2. HERO SECTION WITH SMOOTH FLOWING WAVE */}
      <section className="w-full relative overflow-hidden py-3 lg:py-5 flex-1 flex items-center">
        {/* Continuous ambient cyan wave matching reference */}
        <div 
          className="absolute right-0 top-0 bottom-0 w-[68%] pointer-events-none select-none opacity-85"
          style={{
            background: 'radial-gradient(ellipse 70% 60% at 48% 48%, rgba(186, 230, 253, 0.5) 0%, rgba(224, 242, 254, 0.28) 45%, rgba(240, 249, 255, 0.08) 75%, transparent 100%)'
          }}
        />

        <div className="max-w-7xl mx-auto w-full px-6 sm:px-8 xl:px-10 flex items-center justify-between gap-6 relative z-10">
          
          {/* Columna Izquierda: Titular H1 + Tarjeta de Confianza */}
          <div className="w-full lg:w-[35%] xl:w-[34%] flex flex-col justify-center">
            <h1 className="text-3xl sm:text-4xl lg:text-[40px] xl:text-[46px] 2xl:text-[50px] font-black text-slate-950 leading-[1.06] tracking-tight mb-5">
            ...
            <div 
              ...
              className="bg-[#ebf4ff] hover:bg-[#e0f0fe] border border-blue-100/90 rounded-2xl p-3.5 px-4 flex items-center gap-3.5 max-w-[430px] shadow-2xs transition-all cursor-pointer group"
            >
              <div className="w-11 h-11 rounded-xl bg-blue-100 text-[#005dff] flex items-center justify-center shrink-0">
                <ShieldCheck size={26} className="stroke-[2.2]" />
              </div>
              <div>
                <h4 className="text-[13px] font-bold text-slate-900 leading-snug group-hover:text-[#005dff] transition-colors">
          ...
          {/* Columna Centro: Emblema Circular con difuminado suave sin bordes duros */}
          <div className="flex-1 flex items-center justify-center relative py-1">
            <img 
              src="/images/mivor_hero_feathered.png" 
              alt="MIVOR.ai" 
              className="w-full max-w-[300px] lg:max-w-[340px] xl:max-w-[380px] 2xl:max-w-[400px] h-auto object-contain relative z-10 select-none pointer-events-none" 
            />
          </div>

          {/* Columna Derecha: Los 3 Pilares con círculos rellenos pastel */}
          <div className="flex flex-col justify-center gap-5 xl:gap-6 w-[27%] xl:w-[25%] shrink-0">
            {/* Pilar 1: TECNOLOGÍA QUE CUIDA */}
            <div className="flex items-center gap-3.5 group cursor-default">
              <div className="w-12 h-12 rounded-full bg-[#dbeefe] text-[#0284c7] flex items-center justify-center shrink-0 group-hover:scale-105 transition-transform shadow-2xs">
                <svg className="w-6 h-6 text-[#0284c7]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.1" strokeLinecap="round" strokeLinejoin="round">
              ...
              <div>
                <h4 className="font-extrabold text-[12px] xl:text-[12.5px] text-slate-900 tracking-wide uppercase leading-tight">
                  {t('pillar_tech_line1') || 'TECNOLOGÍA'}<br />
                  {t('pillar_tech_line2') || 'QUE CUIDA'}
                </h4>
                <p className="text-[10.5px] xl:text-[11px] text-slate-500 leading-snug mt-0.5">
            ...
            <div className="flex items-center gap-3.5 group cursor-default">
              <div className="w-12 h-12 rounded-full bg-[#ccfbf1] text-[#0d9488] flex items-center justify-center shrink-0 group-hover:scale-105 transition-transform shadow-2xs">
                <svg className="w-6 h-6 text-[#0d9488]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.1" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className="flex items-center gap-3.5 group cursor-default">
              <div className="w-12 h-12 rounded-full bg-[#f3e8ff] text-[#9333ea] flex items-center justify-center shrink-0 group-hover:scale-105 transition-transform shadow-2xs">
                <svg className="w-6 h-6 text-[#9333ea]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.1" strokeLinecap="round" strokeLinejoin="round">
      ...
      {/* 3. CINCO TARJETAS COMPACTAS (Colores y dimensiones idénticas al diseño oficial) */}
      <section className="w-full pb-6 pt-1">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 xl:px-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3.5 xl:gap-4">
          
          {/* Tarjeta 1: Pregunta a MIVOR.ai (Pastel Lavender #f4f2fd) */}
          <div 
            onClick={() => onNavigate('general_chat')}
            className="bg-[#f4f2fd] hover:bg-[#ede9fc] border border-purple-100/80 rounded-2xl p-4 flex flex-col justify-between min-h-[178px] xl:min-h-[188px] shadow-2xs hover:shadow-md hover:-translate-y-0.5 transition-all cursor-pointer group"
          >
            <div>
              <div className="w-10 h-10 rounded-full bg-[#ece6fb] flex items-center justify-center text-[#7012ff] mb-2 group-hover:scale-105 transition-transform">
                <Brain size={22} className="stroke-[2.2]" />
              </div>
              <h3 className="font-extrabold text-[13.5px] xl:text-[14px] text-slate-900 mb-1 leading-snug">
                {t('card_ask_title') || 'Pregunta a MIVOR.ai'}
              </h3>
              <p className="text-[10.5px] xl:text-[11px] text-slate-600 leading-snug font-normal">
            ...
            <div className="w-8 h-8 rounded-full bg-[#5d05f8] text-white flex items-center justify-center shadow-xs group-hover:scale-110 active:scale-95 transition-transform self-end mt-2">
              <ArrowRight size={14} className="stroke-[2.5]" />
            </div>
          </div>

          {/* Tarjeta 2: Analiza tus pruebas médicas (Pastel Sky Blue #eaf7ff) */}
          <div 
            onClick={() => onNavigate('documents')}
            className="bg-[#eaf7ff] hover:bg-[#ddf1fe] border border-blue-100/80 rounded-2xl p-4 flex flex-col justify-between min-h-[178px] xl:min-h-[188px] shadow-2xs hover:shadow-md hover:-translate-y-0.5 transition-all cursor-pointer group"
          >
            <div>
              <div className="w-10 h-10 rounded-full bg-[#dcf1fd] flex items-center justify-center text-[#005dff] mb-2 group-hover:scale-105 transition-transform">
                <svg className="w-5 h-5 text-[#005dff]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className="w-8 h-8 rounded-full bg-[#005dff] text-white flex items-center justify-center shadow-xs group-hover:scale-110 active:scale-95 transition-transform self-end mt-2">
              <ArrowRight size={14} className="stroke-[2.5]" />
            </div>
          </div>

          {/* Tarjeta 3: Organiza tu historial de salud (Pastel Mint #e8fdf8) */}
          <div 
            onClick={() => onNavigate('history')}
            className="bg-[#e8fdf8] hover:bg-[#daf8f0] border border-emerald-100/80 rounded-2xl p-4 flex flex-col justify-between min-h-[178px] xl:min-h-[188px] shadow-2xs hover:shadow-md hover:-translate-y-0.5 transition-all cursor-pointer group"
          >
            <div>
              <div className="w-10 h-10 rounded-full bg-[#dcf7f0] flex items-center justify-center text-[#01c6af] mb-2 group-hover:scale-105 transition-transform">
            ...
            <div className="w-8 h-8 rounded-full bg-[#01c6af] text-white flex items-center justify-center shadow-xs group-hover:scale-110 active:scale-95 transition-transform self-end mt-2">
              <ArrowRight size={14} className="stroke-[2.5]" />
            </div>
          </div>

          {/* Tarjeta 4: Últimos avances médicos (Pastel Warm Peach #fef7f1) */}
          <div 
            onClick={() => onNavigate('search')}
            className="bg-[#fef7f1] hover:bg-[#fdeee3] border border-orange-100/80 rounded-2xl p-4 flex flex-col justify-between min-h-[178px] xl:min-h-[188px] shadow-2xs hover:shadow-md hover:-translate-y-0.5 transition-all cursor-pointer group"
          >
            <div>
              <div className="w-10 h-10 rounded-full bg-[#feeade] flex items-center justify-center text-[#fd7727] mb-2 group-hover:scale-105 transition-transform">
            ...
            <div className="w-8 h-8 rounded-full bg-[#fd7727] text-white flex items-center justify-center shadow-xs group-hover:scale-110 active:scale-95 transition-transform self-end mt-2">
              <ArrowRight size={14} className="stroke-[2.5]" />
            </div>
          </div>

          {/* Tarjeta 5: Encuentra tu médico (Pastel Violet #f5f3fe) */}
          <div 
            onClick={() => onNavigate('doctors')}
            className="bg-[#f5f3fe] hover:bg-[#eae6fc] border border-purple-100/80 rounded-2xl p-4 flex flex-col justify-between min-h-[178px] xl:min-h-[188px] shadow-2xs hover:shadow-md hover:-translate-y-0.5 transition-all cursor-pointer group"
          >
            <div>
              <div className="w-10 h-10 rounded-full bg-[#ece6fb] flex items-center justify-center text-[#5803f6] mb-2 group-hover:scale-105 transition-transform">
                <svg className="w-5 h-5 text-[#5803f6]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className="w-8 h-8 rounded-full bg-[#5803f6] text-white flex items-center justify-center shadow-xs group-hover:scale-110 active:scale-95 transition-transform self-end mt-2">
              <ArrowRight size={14} className="stroke-[2.5]" />
            </div>
          </div>
