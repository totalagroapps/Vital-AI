      ...
      <div className="block lg:hidden w-full h-[100dvh] max-h-[100dvh] bg-white font-sans text-black flex flex-col justify-between overflow-hidden select-none pb-[58px] sm:pb-[62px] mivor-mobile-home">
        ...
        <main className="flex-1 min-h-0 flex flex-col justify-between px-3 sm:px-4 py-1 sm:py-1.5 gap-1.5 sm:gap-2 overflow-hidden mobile-main">
          ...
          >
            ...
            <div className="w-[82px] h-[82px] sm:w-[96px] sm:h-[96px] shrink-0 relative flex items-center justify-center mobile-hero-emblem">
              <div className="absolute w-[76px] h-[76px] sm:w-[88px] sm:h-[88px] rounded-full bg-sky-300/40 blur-xl pointer-events-none" />
              <img 
                src="/images/mivor_hero_circle_clean.png" 
                alt="MIVOR.ai" 
          ...
          <div className="grid grid-cols-2 gap-2 sm:gap-2.5 flex-1 min-h-0 items-stretch mobile-grid">
            ...
            >
              <div className="flex items-center justify-between shrink-0 mb-1 sm:mb-1.5">
                ...
                <div className="w-6.5 h-6.5 sm:w-7 sm:h-7 rounded-full bg-[#00ab84] text-white flex items-center justify-center shadow-xs group-hover:scale-105 transition-transform shrink-0 mobile-card-arrow">
                  <ArrowRight size={13} className="stroke-[2.8]" />
                </div>
              </div>
              <div className="flex-1 min-h-0 flex flex-col justify-center gap-1">
            ...
            >
              <div className="flex items-center justify-between shrink-0 mb-1 sm:mb-1.5">
                ...
                <div className="w-6.5 h-6.5 sm:w-7 sm:h-7 rounded-full bg-[#8527e8] text-white flex items-center justify-center shadow-xs group-hover:scale-105 transition-transform shrink-0 mobile-card-arrow">
                  <ArrowRight size={13} className="stroke-[2.8]" />
                </div>
              </div>
              <div className="flex-1 min-h-0 flex flex-col justify-center gap-1">
