...
async def upload_document(
    ...
    try:
        if file.content_type == "application/pdf" or file_extension == "pdf":
            ...
            ollama_host = os.getenv("OLLAMA_HOST", "https://roberts-cherry-vector-pearl.trycloudflare.com")
...
"""
    ...
    try:
        def stream_generator():
            client = ollama.AsyncClient(host=os.getenv("OLLAMA_HOST", "https://roberts-cherry-vector-pearl.trycloudflare.com"))
