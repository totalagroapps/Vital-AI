    ...
    async with database.AsyncSessionLocal() as session:
        ...
        if not spec_profile:
            spec_profile = models.SpecialistProfile(
                ...
                bio="Especialista en Medicina Familiar, Urgencias Clínicas y Orientación Médica Digital en MIVOR.ai. Más de 12 años coordinando equipos médicos de atención ambulatoria y hospitalaria.",
                verified=True,
                is_verified=True,
        ...
        appointments_to_seed = [
            # --- HOY (Citas clave para la demo) ---
            {
                ...
                "duration_minutes": 30,
                "reason": "Revisión urgente de salud por dolor torácico opresivo con disnea",
