...
if '[DOCUMENTOS MÉDICOS ADJUNTOS]' not in content:
    # Need to be careful about replacing strings that have special characters or backslashes.
    content = content.replace(old_context, new_context)
    with open('backend/main.py', 'w', encoding='utf-8') as f:
        f.write(content)
    print("Patched Copilot context")
else:
    print("Copilot context already patched")
